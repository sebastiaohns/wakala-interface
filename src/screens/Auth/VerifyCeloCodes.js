                        ...
                        {!allSet ?
                            <>
                                ...
                                <View style={{width: "100%"}}>
                                    <Text style={{...FONTS.body4, textAlign: "left", alignSelf: "flex-start"}}>We sent
                                        three codes to <Text
                                            style={{fontWeight: "bold", fontFamily: "Rubik_600SemiBold"}}>+254 706 111
                                            427</Text>,{"\n"}please enter them below</Text>
                                </View>
                                <View style={{width: "100%"}}>
                                ...
                                <TouchableOpacity onPress={() => moveNext()}
                                                  style={{}}><Text style={FONTS.body4}>Skip (will be removed)</Text>
                                </TouchableOpacity>

                                <TouchableOpacity>
                                    <Text style={{...FONTS.body3, color: COLORS.primary}}>Resend all messages</Text>
                                </TouchableOpacity>
                            </>
                            :
                            <View style={{width: "100%", justifyContent: "center", alignItems: "center"}}>
                                <Image source={logo}/>
                                <Text style={{...FONTS.h1, color: COLORS.primary, paddingTop: 10}}>You're all set!</Text>
                            </View>
                        }
...
export default VerifyCeloCodes;